...
// gameState.player = this.physics.add.sprite(200, 10, 'codey').setScale(.5);
  ...
  const abCoord = Math.random() * 300;
   platforms.create(225, mCoord+100, 'platform').setScale(2, .7).refreshBody();
   platforms.create(500, yCoord, 'platform').setScale(.1, .7).refreshBody();
   platforms.create(600, qCoord, 'platform').setScale(.1, .7).refreshBody();
   platforms.create(700, wCoord, 'platform').setScale(.1, .7).refreshBody();
   platforms.create(800, eCoord, 'platform').setScale(.1, .7).refreshBody();
