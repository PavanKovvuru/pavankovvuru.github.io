...
// gameState.player = this.physics.add.sprite(200, 10, 'codey').setScale(.5);
  ...
  const abCoord = Math.random() * 300;
   ...
   platforms.create(500, yCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(600, qCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(700, wCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(800, eCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(900, rCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1000, tCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1100, uCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1200, iCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1300, oCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1400, pCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1500, aCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1600, sCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(550, dCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(650, fCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(750, gCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(850, hCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(950, jCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1050, kCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1150, lCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1250, zCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1350, xCoord, 'platform').setScale(.08, .4).refreshBody();
   platforms.create(1450, cCoord, 'platform').setScale(.08, .4).refreshBody();
...
this.physics.add.collider(gameState.player, walls, () => {
   //snow.destroy();
    ...
    snowGenLoop.destroy();
    this.physics.pause();
     this.add.text(680, 320, 'Cake acquired', { fontSize: '80px', fill: '#ffffff' });
     this.add.text(550, 450, 'Happy Birthday Bella', { fontSize: '80px', fill: '#ffffff' });
