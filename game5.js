function preload() {
  this.load.image('bug1', 'https://raw.githubusercontent.com/PavanKovvuru/pavankovvuru.github.io/master/pixil-frame-0%20(3).png')
  ...
  this.load.image('codey', 'https://raw.githubusercontent.com/PavanKovvuru/pavankovvuru.github.io/master/pixil-frame-5%20(3).png')
...
function create() {
  ...
  function bugGen () {
    ...
    bugs.create(xCoord-20, 650, 'bug1').setScale(.50);
   // this.body.velocity.x = bugs.SPEED;
    // this.body.velocity.x = 80;
   }
  //  bugs.SPEED = 100;
