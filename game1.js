...
// gameState.player = this.physics.add.sprite(200, 10, 'codey').setScale(.5);
 ...
 // const walls = this.physics.add.staticGroup();
  ...
  const bCoord = Math.random() * 900;
   ...
   platforms.create(225, mCoord+51, 'platform').setScale(1, .3).refreshBody();
   platforms.create(500, yCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(600, qCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(700, wCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(800, eCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(900, rCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1000, tCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1100, uCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1200, iCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1300, oCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1400, pCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1500, aCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1600, sCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(550, dCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(650, fCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(750, gCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(850, hCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(950, jCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1050, kCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1150, lCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1250, zCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1350, xCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1450, cCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1550, vCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1650, bCoord+1, 'platform').setScale(.05, .3).refreshBody();
   platforms.create(1950, 681, 'platform').setScale(1, .3).refreshBody();
